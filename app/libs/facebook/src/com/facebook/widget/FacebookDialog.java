...
public class FacebookDialog {
     ...
     * {@link FacebookDialog#canPresentShareDialog(Context,
     ...
     * As additional features are added, these flags may be passed to
     * {@link FacebookDialog#canPresentMessageDialog(Context,
     ...
     * {@link FacebookDialog#canPresentOpenGraphActionDialog(Context,
     ...
     * application. As additional features are added, these flags may be passed to
     * {@link FacebookDialog#canPresentOpenGraphMessageDialog(Context,
     ...
     * should only be used if {@link FacebookDialog#canPresentShareDialog(Context,
     ...
     * installed, so it should only be used if {@link FacebookDialog#canPresentShareDialog(Context,
     * com.facebook.widget.FacebookDialog.ShareDialogFeature...)}  indicates the capability is available.
     */
     ...
     * installed, so it should only be used if {@link FacebookDialog#canPresentMessageDialog(Context,
     ...
     * should only be used if {@link FacebookDialog#canPresentMessageDialog(Context,
     * com.facebook.widget.FacebookDialog.MessageDialogFeature...)}  indicates the capability is available.
     ...
     * should only be used if {@link FacebookDialog#canPresentOpenGraphActionDialog(Context,
     ...
     * action and any Open Graph objects to be created prior to publishing the action.
     * This builder will throw an exception if the Facebook application is not installed, so it
     * should only be used if {@link FacebookDialog#canPresentOpenGraphMessageDialog(Context,
