...
public class Request {
     ...
     * {@link Settings#setLimitEventAndDataUsage(Context, boolean)} with `true` for this user.
    ...
    /**
     * Specifies the interface that consumers of
     * {@link Request#executePlacesSearchRequestAsync(Session, Location, int, int, String, com.facebook.Request.GraphPlaceListCallback)}
     * can use to be notified when the request completes, either successfully or with an error.
     */
